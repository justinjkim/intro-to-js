...
// console.log("Tim is " + TimsAge + " 33 years old");


// 8.
// Adjust this code. Store some information in the following variables.
// A:
let yourName = "Justin Kim";
let instructorName = "Kelly Murray";


// 9.
// Update the variables `yourName` and `instructorName` so the expression below reads correctly.
// A:
// I do not understand this question, it seems like the answer to question 8 already answers #9.
